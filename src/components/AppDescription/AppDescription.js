...
const AppDescription = ({activeTheme}) => {
    return (
        <div className={`${styled.appdescription__wrapper} ${styled[activeTheme]}`}>
            <h1 className={styled.appdescription__header}>What is Image Geoloc App ?</h1>
            <div className={styled.appdescription__text}>
